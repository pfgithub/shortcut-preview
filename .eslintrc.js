module.exports = {
  ...
  "rules": {
    ...
    "key-spacing": [1, {"beforeColon": false, "afterColon": true, "mode": "strict"}],// enforces spacing between keys and values in object literal properties
    ...
    "quotes": [1, "single", {"avoidEscape": true, "allowTemplateLiterals": true}], // specify whether double or single quotes should be used
